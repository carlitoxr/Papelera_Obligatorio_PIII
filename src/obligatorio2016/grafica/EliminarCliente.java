...
public class EliminarCliente extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        Enumeration<Cliente> eProv = Fachada.getInstancia().getDiccioCtes().getColeccion().elements();
        while(eProv.hasMoreElements()){
            Cliente cte = eProv.nextElement();
            Object [] fila = new Object[4];
            fila[0] = cte.getRUT_CI();
            fila[1] = cte.getNomCte();
            modelo.addRow(fila);
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        Fachada.getInstancia().getDiccioCtes().delete(Long.parseLong(jTextField1.getText()));
